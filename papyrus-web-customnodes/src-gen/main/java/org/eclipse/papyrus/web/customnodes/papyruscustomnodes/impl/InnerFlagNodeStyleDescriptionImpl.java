 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#getFontSize
 * <em>Font Size</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#isItalic
 * <em>Italic</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#isBold
 * <em>Bold</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#isUnderline
 * <em>Underline</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#isStrikeThrough
 ...
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#getLabelColor
 * <em>Label Color</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#isShowIcon
 * <em>Show Icon</em>}</li>
 * <li>{@link org.eclipse.papyrus.web.customnodes.papyruscustomnodes.impl.InnerFlagNodeStyleDescriptionImpl#getLabelIcon
 * <em>Label Icon</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InnerFlagNodeStyleDescriptionImpl extends StyleImpl implements InnerFlagNodeStyleDescription {
    /**
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public UserColor getLabelColor() {
        if (this.labelColor != null && this.labelColor.eIsProxy()) {
            ...
            if (this.labelColor != oldLabelColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
            }
        }
    ...
    public void setLabelColor(UserColor newLabelColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
    }
    ...
    public void setShowIcon(boolean newShowIcon) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__SHOW_ICON, oldShowIcon, this.showIcon));
    }
    ...
    public void setLabelIcon(String newLabelIcon) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__LABEL_ICON, oldLabelIcon, this.labelIcon));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__FONT_SIZE:
                return this.getFontSize();
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__ITALIC:
                return this.isItalic();
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BOLD:
                return this.isBold();
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__UNDERLINE:
                return this.isUnderline();
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH:
            ...
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__LABEL_COLOR:
                if (resolve)
                    return this.getLabelColor();
                return this.basicGetLabelColor();
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__SHOW_ICON:
                return this.isShowIcon();
            case PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__LABEL_ICON:
        ...
        if (baseClass == LabelStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.LABEL_STYLE__FONT_SIZE:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__FONT_SIZE;
                case ViewPackage.LABEL_STYLE__ITALIC:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__ITALIC;
                case ViewPackage.LABEL_STYLE__BOLD:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BOLD;
                case ViewPackage.LABEL_STYLE__UNDERLINE:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__UNDERLINE;
                case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH;
                default:
                    return -1;
            }
        }
        if (baseClass == BorderStyle.class) {
            switch (baseFeatureID) {
                case DiagramPackage.BORDER_STYLE__BORDER_COLOR:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BORDER_COLOR;
                case DiagramPackage.BORDER_STYLE__BORDER_RADIUS:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BORDER_RADIUS;
                case DiagramPackage.BORDER_STYLE__BORDER_SIZE:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BORDER_SIZE;
                case DiagramPackage.BORDER_STYLE__BORDER_LINE_STYLE:
                    return PapyrusCustomNodesPackage.INNER_FLAG_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE;
                default:
                    return -1;
            }
        }
