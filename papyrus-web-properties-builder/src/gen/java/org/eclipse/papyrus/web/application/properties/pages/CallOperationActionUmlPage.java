...
public class CallOperationActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public CallOperationActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createCallOperationActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("callOperationAction_uml_page", "uml::CallOperationAction", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createCallOperationActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("callOperationAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
