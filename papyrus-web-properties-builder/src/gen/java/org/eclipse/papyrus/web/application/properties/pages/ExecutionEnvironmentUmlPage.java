...
public class ExecutionEnvironmentUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ExecutionEnvironmentUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createExecutionEnvironmentUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("executionEnvironment_uml_page", "uml::ExecutionEnvironment", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createExecutionEnvironmentUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("executionEnvironment_uml_group", "", "var:self", GroupDisplayMode.LIST);
