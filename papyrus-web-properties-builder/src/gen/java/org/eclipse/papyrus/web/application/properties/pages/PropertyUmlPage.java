...
public class PropertyUmlPage {
    ...
    public PropertyUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected void addRedefinedProperty(GroupDescription group) {
        var builder = new MultiReferenceWidgetBuilder() //
                ...
                .label("aql:'Redefined property'") //
                .help("aql:self.getFeatureDescription('redefinedProperty')") //
                .isEnable("aql:self.eClass().getEStructuralFeature('redefinedProperty').changeable") //
                .owner("") //
                .type("aql:self.getFeatureTypeQualifiedName('redefinedProperty')") //
                .value("feature:redefinedProperty") //
                .searchScope("aql:self.getAllReachableRootElements()") //
                .dropdownOptions("aql:self.getAllReachableElements('redefinedProperty')") //
                .createOperation("aql:parent.create(kind, feature)") //
                .addOperation("aql:self.addReferenceElement(newValue, 'redefinedProperty')") //
                .removeOperation("aql:item.delete(self, 'redefinedProperty'))") //
                .reorderOperation("aql:self.moveReferenceElement('redefinedProperty', item, fromIndex, toIndex)") //
                .clearOperation("aql:self.clearReference('redefinedProperty')"); //
        group.getChildren().add(builder.build());
    }
