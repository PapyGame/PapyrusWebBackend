...
public class ExpansionNodeUmlPage {
    ...
    protected void addRegionAsInput(GroupDescription group) {
        var builder = new MonoReferenceWidgetBuilder() //
                ...
                .createOperation("aql:parent.create(kind, feature)") //
                .setOperation("aql:self.updateReference(newValue,'regionAsInput')") //
                .unsetOperation("aql:item.delete(self, 'regionAsInput'))") //
                .clearOperation("aql:self.clearReference('regionAsInput')"); //
        group.getChildren().add(builder.build());
    }
    ...
    protected void addRegionAsOutput(GroupDescription group) {
        var builder = new MonoReferenceWidgetBuilder() //
                ...
                .createOperation("aql:parent.create(kind, feature)") //
                .setOperation("aql:self.updateReference(newValue,'regionAsOutput')") //
                .unsetOperation("aql:item.delete(self, 'regionAsOutput'))") //
                .clearOperation("aql:self.clearReference('regionAsOutput')"); //
        group.getChildren().add(builder.build());
    }
