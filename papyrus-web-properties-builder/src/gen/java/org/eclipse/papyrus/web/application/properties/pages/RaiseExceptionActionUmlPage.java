...
public class RaiseExceptionActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public RaiseExceptionActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createRaiseExceptionActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("raiseExceptionAction_uml_page", "uml::RaiseExceptionAction", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createRaiseExceptionActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("raiseExceptionAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
    ...
    protected void addException(GroupDescription group) {
        var builder = new ContainmentReferenceWidgetBuilder() //
                .name("exception") //
                .label("aql:'Exception'") //
                .help("aql:self.getFeatureDescription('exception')") //
                .isEnable("aql:self.eClass().getEStructuralFeature('exception').changeable") //
                .owner("") //
                .type("aql:self.getFeatureTypeQualifiedName('exception')") //
                .isMany(false) //
                .value("feature:exception") //
                .createOperation("aql:parent.create(kind, feature)") //
                .removeOperation("aql:item.delete(self, 'exception'))");
