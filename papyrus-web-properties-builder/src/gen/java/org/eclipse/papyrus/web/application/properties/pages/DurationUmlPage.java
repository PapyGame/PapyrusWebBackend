...
public class DurationUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public DurationUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("duration_uml_page", "uml::Duration", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createDurationUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("duration_uml_group", "", "var:self", GroupDisplayMode.LIST);
