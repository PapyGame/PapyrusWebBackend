...
public class NodeUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public NodeUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("node_uml_page", "uml::Node", "aql:'UML'", "aql:self",
                "aql:not(self.oclIsKindOf(uml::Device)) and not(self.oclIsKindOf(uml::ExecutionEnvironment)) and not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createNodeUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("node_uml_group", "", "var:self", GroupDisplayMode.LIST);
