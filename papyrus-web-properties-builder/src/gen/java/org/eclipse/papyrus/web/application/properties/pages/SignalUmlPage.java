...
public class SignalUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public SignalUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("signal_uml_page", "uml::Signal", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createSignalUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("signal_uml_group", "", "var:self", GroupDisplayMode.LIST);
