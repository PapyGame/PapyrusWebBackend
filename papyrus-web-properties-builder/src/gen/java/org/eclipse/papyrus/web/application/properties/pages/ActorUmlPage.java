...
public class ActorUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ActorUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("actor_uml_page", "uml::Actor", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createActorUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("actor_uml_group", "", "var:self", GroupDisplayMode.LIST);
