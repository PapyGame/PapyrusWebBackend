...
public class UnmarshallActionUmlPage {
    ...
    public UnmarshallActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createUnmarshallActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("unmarshallAction_uml_page", "uml::UnmarshallAction", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createUnmarshallActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("unmarshallAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
    ...
    protected void addUnmarshallType(GroupDescription group) {
        var builder = new MonoReferenceWidgetBuilder() //
                .name("unmarshallType") //
                .label("aql:'Unmarshall type'") //
                .help("aql:self.getFeatureDescription('unmarshallType')") //
                .isEnable("aql:self.eClass().getEStructuralFeature('unmarshallType').changeable") //
                .owner("") //
                .type("aql:self.getFeatureTypeQualifiedName('unmarshallType')") //
                .value("feature:unmarshallType") //
                .searchScope("aql:self.getAllReachableRootElements()") //
                .dropdownOptions("aql:self.getAllReachableElements('unmarshallType')") //
                .createOperation("aql:parent.create(kind, feature)") //
                .setOperation("aql:self.updateReference(newValue,'unmarshallType')") //
                .unsetOperation("aql:item.delete(self, 'unmarshallType'))") //
                .clearOperation("aql:self.clearReference('unmarshallType')"); //
        group.getChildren().add(builder.build());
    }
