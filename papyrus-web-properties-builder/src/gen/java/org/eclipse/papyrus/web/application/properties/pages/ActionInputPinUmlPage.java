...
public class ActionInputPinUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ActionInputPinUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createActionInputPinUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("actionInputPin_uml_page", "uml::ActionInputPin", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createActionInputPinUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("actionInputPin_uml_group", "", "var:self", GroupDisplayMode.LIST);
    ...
    protected void addFromAction(GroupDescription group) {
        var builder = new ContainmentReferenceWidgetBuilder() //
                .name("fromAction") //
                .label("aql:'From action'") //
                ...
                .createOperation("aql:parent.create(kind, feature)") //
                .removeOperation("aql:item.delete(self, 'fromAction'))");
        group.getChildren().add(builder.build());
    }
