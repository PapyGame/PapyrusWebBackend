...
public class ReadLinkActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ReadLinkActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createReadLinkActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("readLinkAction_uml_page", "uml::ReadLinkAction", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createReadLinkActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("readLinkAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
