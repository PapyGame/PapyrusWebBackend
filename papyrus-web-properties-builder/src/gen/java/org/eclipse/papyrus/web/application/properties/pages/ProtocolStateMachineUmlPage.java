...
public class ProtocolStateMachineUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ProtocolStateMachineUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createProtocolStateMachineUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("protocolStateMachine_uml_page", "uml::ProtocolStateMachine", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createProtocolStateMachineUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("protocolStateMachine_uml_group", "", "var:self", GroupDisplayMode.LIST);
