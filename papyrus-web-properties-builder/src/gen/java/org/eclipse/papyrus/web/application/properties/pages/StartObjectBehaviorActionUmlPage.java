...
public class StartObjectBehaviorActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public StartObjectBehaviorActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createStartObjectBehaviorActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("startObjectBehaviorAction_uml_page", "uml::StartObjectBehaviorAction", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createStartObjectBehaviorActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("startObjectBehaviorAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
