...
public class ValueSpecificationActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ValueSpecificationActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createValueSpecificationActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("valueSpecificationAction_uml_page", "uml::ValueSpecificationAction", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createValueSpecificationActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("valueSpecificationAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
