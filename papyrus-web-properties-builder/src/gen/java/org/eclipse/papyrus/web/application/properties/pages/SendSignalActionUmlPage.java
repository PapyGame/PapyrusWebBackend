...
public class SendSignalActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public SendSignalActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createSendSignalActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("sendSignalAction_uml_page", "uml::SendSignalAction", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createSendSignalActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("sendSignalAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
