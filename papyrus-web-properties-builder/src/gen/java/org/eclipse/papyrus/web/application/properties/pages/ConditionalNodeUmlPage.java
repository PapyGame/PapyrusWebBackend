...
public class ConditionalNodeUmlPage {
    ...
    public ConditionalNodeUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected void addClause(GroupDescription group) {
        var builder = new ContainmentReferenceWidgetBuilder() //
                ...
                .removeOperation("aql:item.delete(self, 'clause'))") //
                .reorderOperation("aql:self.moveReferenceElement('clause', item, fromIndex, toIndex)");
