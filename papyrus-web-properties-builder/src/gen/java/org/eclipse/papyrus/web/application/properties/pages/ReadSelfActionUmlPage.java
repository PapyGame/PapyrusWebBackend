...
public class ReadSelfActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ReadSelfActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createReadSelfActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("readSelfAction_uml_page", "uml::ReadSelfAction", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createReadSelfActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("readSelfAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
