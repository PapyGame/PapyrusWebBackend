...
public class StateMachineUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public StateMachineUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createStateMachineUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("stateMachine_uml_page", "uml::StateMachine", "aql:'UML'", "aql:self",
                "aql:not(self.oclIsKindOf(uml::ProtocolStateMachine)) and not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createStateMachineUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("stateMachine_uml_group", "", "var:self", GroupDisplayMode.LIST);
