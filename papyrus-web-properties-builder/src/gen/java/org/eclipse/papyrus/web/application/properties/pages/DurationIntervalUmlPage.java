...
public class DurationIntervalUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public DurationIntervalUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createDurationIntervalUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("durationInterval_uml_page", "uml::DurationInterval", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createDurationIntervalUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("durationInterval_uml_group", "", "var:self", GroupDisplayMode.LIST);
