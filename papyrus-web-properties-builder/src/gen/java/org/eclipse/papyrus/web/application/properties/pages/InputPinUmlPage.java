...
public class InputPinUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public InputPinUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("inputPin_uml_page", "uml::InputPin", "aql:'UML'", "aql:self",
                "aql:not(self.oclIsKindOf(uml::ActionInputPin)) and not(self.oclIsKindOf(uml::ValuePin)) and not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createInputPinUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("inputPin_uml_group", "", "var:self", GroupDisplayMode.LIST);
