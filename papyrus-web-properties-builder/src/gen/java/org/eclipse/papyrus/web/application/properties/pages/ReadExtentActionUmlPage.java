...
public class ReadExtentActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ReadExtentActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createReadExtentActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("readExtentAction_uml_page", "uml::ReadExtentAction", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createReadExtentActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("readExtentAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
