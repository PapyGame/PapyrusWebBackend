...
public class ActivityParameterNodeUmlPage {
    ...
    public ActivityParameterNodeUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    protected void addParameter(GroupDescription group) {
        var builder = new MonoReferenceWidgetBuilder() //
                ...
                .createOperation("aql:parent.create(kind, feature)") //
                .setOperation("aql:self.updateReference(newValue,'parameter')") //
                .unsetOperation("aql:item.delete(self, 'parameter'))") //
