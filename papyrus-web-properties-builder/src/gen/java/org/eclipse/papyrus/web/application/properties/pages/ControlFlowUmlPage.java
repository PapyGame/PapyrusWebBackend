...
public class ControlFlowUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ControlFlowUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createControlFlowUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("controlFlow_uml_page", "uml::ControlFlow", "aql:'UML'", "aql:self", "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createControlFlowUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("controlFlow_uml_group", "", "var:self", GroupDisplayMode.LIST);
