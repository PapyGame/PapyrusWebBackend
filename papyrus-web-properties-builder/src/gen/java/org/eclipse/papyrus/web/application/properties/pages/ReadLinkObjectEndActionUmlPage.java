...
public class ReadLinkObjectEndActionUmlPage {

    protected final ViewElementsFactory viewElementFactory;

    protected final ColorRegistry colorRegistry;

    public ReadLinkObjectEndActionUmlPage(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
        super();
    ...
    public PageDescription create() {
        ...
        createReadLinkObjectEndActionUmlGroup(page);
    ...
    protected PageDescription createPage() {
        return viewElementFactory.createPageDescription("readLinkObjectEndAction_uml_page", "uml::ReadLinkObjectEndAction", "aql:'UML'", "aql:self",
                "aql:not(selection->size()>1) and not(self.isMetaclass())");
    }

    protected void createReadLinkObjectEndActionUmlGroup(PageDescription page) {
        GroupDescription group = viewElementFactory.createGroupDescription("readLinkObjectEndAction_uml_group", "", "var:self", GroupDisplayMode.LIST);
