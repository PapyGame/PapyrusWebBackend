...
/**
 * Custom implementation of CreateLinkObjectActionUmlPage.
 * 
 * @author Arthur Daussy
 */
public class CreateLinkObjectActionUmlPageCustomImpl extends CreateLinkObjectActionUmlPage {

    public CreateLinkObjectActionUmlPageCustomImpl(ViewElementsFactory viewElementFactory, ColorRegistry colorRegistry) {
    ...
    protected void addEndData(GroupDescription group) {
        var builder = new ContainmentReferenceWidgetBuilder() //
                ...
                .type("aql:'uml::LinkEndCreationData'") //
                .isMany(true) //
