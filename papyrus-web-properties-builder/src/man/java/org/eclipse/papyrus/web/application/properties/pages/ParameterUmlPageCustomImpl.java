...
public class ParameterUmlPageCustomImpl extends ParameterUmlPage {
    ...
    /**
     * AQL has trouble with the following services (using lamba). To force AQL to use the feature instead of the service
     * we need to add a extra '_' </br>
     * Matching: feature:isUnique
     */
    @Override
